...
const PATH_PUBLIC_VSCODE = nodePath.join(
  TEMP_DIR,
  'node_modules/@khulnasoft/web-ide/dist/public/vscode',
);
const PATH_PUBLIC_VSCODE_NODE_MODULES = nodePath.join(PATH_PUBLIC_VSCODE, 'node_modules');

describe('@khulnasoft/web-ide package', () => {
  test('does not have extraneous html files', async () => {
    ...
    assert.deepStrictEqual(htmlChildren, [
      ...
      'extensions/khulnasoft-vscode-extension/webviews/security_finding/index.html',
      'extensions/khulnasoft-vscode-extension/webviews/gitlab_duo_chat/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/theming-preview/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/security-vuln-details/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/root/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/duo-workflow-panel/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/duo-chat-v2/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/agentic-tabs/index.html',
      'extensions/khulnasoft-vscode-extension/assets/language-server/webviews/agentic-duo-chat/index.html',
  ...
  test('contains vscode/node_modules', async () => {
    ...
    // https://gitlab.com/khulnasoft/web-ide/-/merge_requests/400
