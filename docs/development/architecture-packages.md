...
The `vscode-extension-khulnasoft-vscode-extension` internal package is used to provide a browser build of the GitLab VS Code extension.
...
- `dist/khulnasoft-vscode-extension/dist-browser...`, which contains the extracted GitLab VS Code extension assets specified
